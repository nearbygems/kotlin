...
class TestTask4SmartPassengers {
  ...
  @Test
  fun test02() = testSmartPassengers(
    setOf(), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test03() = testSmartPassengers(
    setOf(2), taxiPark(0..2, 0..2,
  ...
  @Test
  fun test04() = testSmartPassengers(
    setOf(0, 1), taxiPark(0..2, 0..2,
  ...
  @Test
  fun test05() = testSmartPassengers(
    setOf(), taxiPark(0..2, 0..2,
  ...
  @Test
  fun test06() = testSmartPassengers(
    setOf(2), taxiPark(0..2, 0..2,
  ...
  @Test
  fun test07() = testSmartPassengers(
    setOf(), taxiPark(0..2, 0..2,
  ...
  @Test
  fun test08() = testSmartPassengers(
    setOf(), taxiPark(0..2, 0..2,
  ...
  @Test
  fun test09() = testSmartPassengers(
    setOf(0, 1, 2, 5), taxiPark(0..9, 0..9,
  ...
  @Test
  fun test10() = testSmartPassengers(
    setOf(3, 8), taxiPark(0..9, 0..9,
  ...
  @Test
  fun test11() = testSmartPassengers(
    setOf(5, 7), taxiPark(0..3, 0..9,

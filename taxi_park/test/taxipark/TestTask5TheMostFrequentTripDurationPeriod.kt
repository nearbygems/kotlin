...
class TestTask5TheMostFrequentTripDurationPeriod {
    ...
    fun test05() = testDurationPeriod(
        setOf(0..9, 10..19, 20..29), taxiPark(
            0..5, 0..9,
    ...
    fun test13() {
        testDurationPeriod(
            setOf(30..39, 4320..4329), taxiPark(
                1..2, 1..2,

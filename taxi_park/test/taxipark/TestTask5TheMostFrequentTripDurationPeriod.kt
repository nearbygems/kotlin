...
class TestTask5TheMostFrequentTripDurationPeriod {
  ...
  @Test
  fun test02() = testDurationPeriod(
    setOf(30..39), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test03() = testDurationPeriod(
    setOf(0..9), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test04() = testDurationPeriod(
    setOf(10..19), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test05() = testDurationPeriod(
    setOf(0..9, 10..19, 20..29), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test06() = testDurationPeriod(
    setOf(0..9, 30..39), taxiPark(0..9, 0..19,
  ...
  @Test
  fun test07() = testDurationPeriod(
    setOf(0..9), taxiPark(0..9, 0..19,
  ...
  @Test
  fun test08() = testDurationPeriod(
    setOf(340..349), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test10() = testDurationPeriod(
    setOf(320..329), taxiPark(0..5, 0..9,
  ...
  @Test
  fun test12() = testDurationPeriod(
    setOf(0..9, 10..19), taxiPark(0..9, 0..19,
  ...
  fun test13() {
    testDurationPeriod(
      setOf(30..39, 4320..4329),
      taxiPark(1..2, 1..2, trip(1, 1, duration = 33), trip(2, 2, duration = 4320))
    )
  }
}
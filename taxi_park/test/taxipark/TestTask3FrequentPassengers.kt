...
class TestTask3FrequentPassengers {
  ...
  @Test
  fun test01() = testFrequentPassengers(
    2, setOf(5, 7), taxiPark(0..2, 0..7,
  ...
  @Test
  fun test02() = testFrequentPassengers(
    1, setOf(1), taxiPark(0..2, 0..7,
    trip(1, listOf(3, 6, 4, 1), duration = 26, distance = 22.0),
    trip(2, listOf(7), duration = 18, distance = 27.0),
    trip(1, listOf(1), duration = 11, distance = 37.0),
    trip(0, listOf(0, 7), duration = 1, distance = 6.0),
  ...
  @Test
  fun test03() = testFrequentPassengers(
    1, setOf(0, 2, 3, 7), taxiPark(0..2, 0..7,
  ...
  @Test
  fun test04() = testFrequentPassengers(
    2, setOf(2, 3, 4, 5), taxiPark(0..2, 0..7,
  ...
  @Test
  fun test05() = testFrequentPassengers(
    2, setOf(), taxiPark(0..5, 0..15,
  ...
  @Test
  fun test06() = testFrequentPassengers(
    3, setOf(3, 13, 15), taxiPark(0..5, 0..15,
  ...
  @Test
  fun test07() = testFrequentPassengers(
    5, setOf(1), taxiPark(0..5, 0..15,
    trip(4, listOf(0, 5), duration = 28, distance = 38.0),
    trip(5, listOf(1, 9), duration = 2, distance = 39.0, discount = 0.4),
    trip(1, listOf(8, 7, 0), duration = 1, distance = 34.0, discount = 0.4),
    trip(0, listOf(11), duration = 2, distance = 11.0, discount = 0.4),
  ...
  @Test
  fun test09() = testFrequentPassengers(
    1, setOf(0, 1, 2, 3, 4, 5), taxiPark(0..1, 0..5,
  ...
  @Test
  fun test10() = testFrequentPassengers(
    1, setOf(0, 1, 2, 4, 5), taxiPark(0..1, 0..5,
